...
declare class FVTTSidebarControl {
     ...
     * @type {object[]}
     */
    static "__#142269@#initData": object[];
    static "__#142269@#initPromise": any;
    /**
     * @type {Map<string, TJSSidebarEntry>}
     */
    static "__#142269@#sidebars": Map<string, TJSSidebarEntry>;
    /**
     ...
     */
    static "__#142269@#initialize"(): void;
    /**
     ...
     */
    static "__#142269@#sidebarAdd"(data: object, sidebarData: object): void;
    /**
     ...
     */
    static "__#142269@#sidebarRemove"(data: object, sidebarData: object): void;
    /**
     ...
     */
    static "__#142269@#sidebarReplace"(data: object, sidebarData: object): void;
    /**
...
declare class TJSContextMenu {
     ...
     */
    static "__#142270@#contextMenu": any;
    /**
     ...
     */
    static "__#142270@#processItems"(items: Iterable<TJSContextMenuItemData>): object[];
}
/**
