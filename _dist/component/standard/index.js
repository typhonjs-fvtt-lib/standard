...
function add_css$b(target) {
	append_styles(target, "svelte-hagbs7", "div.svelte-hagbs7{display:block;flex:0 0 var(--tjs-icon-button-diameter);height:var(--tjs-icon-button-diameter);width:var(--tjs-icon-button-diameter);align-self:center;text-align:center}a.svelte-hagbs7{display:inline-block;background:var(--tjs-icon-button-background);border-radius:var(--tjs-icon-button-border-radius);position:relative;overflow:hidden;clip-path:var(--tjs-icon-button-clip-path, none);transform-style:preserve-3d;width:100%;height:100%;transition:var(--tjs-icon-button-transition)}a.svelte-hagbs7:hover{background:var(--tjs-icon-button-background-hover);clip-path:var(--tjs-icon-button-clip-path-hover, var(--tjs-icon-button-clip-path, none))}i.svelte-hagbs7{line-height:var(--tjs-icon-button-diameter);transform:translateZ(1px)}");
}
...
function create_fragment$c(ctx) {
	...
	return {
		c() {
			...
			a = element("a");
			i = element("i");
			attr(i, "class", i_class_value = "" + (null_to_empty(/*icon*/ ctx[0]) + " svelte-hagbs7"));
			attr(i, "title", i_title_value = localize(/*title*/ ctx[1]));
			attr(a, "class", "svelte-hagbs7");
			attr(div, "class", "svelte-hagbs7");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen(div, "close", /*close_handler*/ ctx[5]),
		...
		p(ctx, [dirty]) {
			if (dirty & /*icon*/ 1 && i_class_value !== (i_class_value = "" + (null_to_empty(/*icon*/ ctx[0]) + " svelte-hagbs7"))) {
...
function instance$b($$self, $$props, $$invalidate) {
	...
	return [icon, title, styles, efx, button, close_handler, click_handler];
}
...
/* src\component\standard\layers\position-control\control\resize\ResizeHitBox.svelte generated by Svelte v3.46.0 */
...
/* src\component\standard\layers\position-control\control\resize\ResizeControl.svelte generated by Svelte v3.46.0 */
...
/* src\component\standard\layers\position-control\control\SelectedBorder.svelte generated by Svelte v3.46.0 */
...
/* src\component\standard\layers\position-control\control\PositionControl.svelte generated by Svelte v3.46.0 */
...
/* src\component\standard\layers\position-control\TJSPositionControlLayer.svelte generated by Svelte v3.46.0 */
