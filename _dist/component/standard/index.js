...
function add_css$3(target) {
	append_styles(target, "svelte-xyl3jn", ".tjs-input-container.svelte-xyl3jn{background:var(--tjs-comp-input-background, var(--tjs-input-background));border-radius:var(--tjs-comp-input-border-radius, var(--tjs-input-border-radius));display:block;overflow:hidden;height:var(--tjs-comp-input-height, var(--tjs-input-height));width:var(--tjs-comp-input-width, var(--tjs-input-width));transform-style:preserve-3d}input.svelte-xyl3jn{display:inline-block;position:relative;overflow:hidden;background:transparent;border:var(--tjs-comp-input-border, var(--tjs-input-border));border-radius:var(--tjs-comp-input-border-radius, var(--tjs-input-border-radius));width:100%;height:100%;color:inherit;font-family:inherit;font-size:inherit;line-height:inherit;cursor:var(--tjs-comp-input-cursor, var(--tjs-input-cursor));transform:translateZ(1px)}");
}
...
function create_fragment$4(ctx) {
	...
	return {
		c() {
			...
			attr(input_1, "class", "tjs-input svelte-xyl3jn");
			input_1.disabled = /*disabled*/ ctx[0];
			attr(div, "class", "tjs-input-container svelte-xyl3jn");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, input_1);
			set_input_value(input_1, /*$store*/ ctx[4]);
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$store*/ 16 && input_1.value !== /*$store*/ ctx[4]) {
				set_input_value(input_1, /*$store*/ ctx[4]);
			}
...
function instance$4($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*input, type*/ 96) {
			$$invalidate(5, type = typeof input === 'object' && typeof input.type === 'string'
			? input.type
			: typeof type === 'string' ? type : void 0);
		}

		if ($$self.$$.dirty & /*input, disabled*/ 65) {
			$$invalidate(0, disabled = typeof input === 'object' && typeof input.disabled === 'boolean'
			? input.disabled
			: typeof disabled === 'boolean' ? disabled : false);
		}

		if ($$self.$$.dirty & /*input, store*/ 66) {
			$$subscribe_store($$invalidate(1, store = typeof input === 'object' && isStore(input.store)
			? input.store
			: isStore(store) ? store : writable(void 0)));
		}

		if ($$self.$$.dirty & /*input, styles*/ 68) {
			$$invalidate(2, styles = typeof input === 'object' && typeof input.styles === 'object'
			? input.styles
			: typeof styles === 'object' ? styles : void 0);
		}

		if ($$self.$$.dirty & /*input, efx*/ 72) {
			$$invalidate(3, efx = typeof input === 'object' && typeof input.efx === 'function'
			? input.efx
			: typeof efx === 'function'
				? efx
				: () => {
	...
	return [disabled, store, styles, efx, $store, type, input, input_1_input_handler];
}
