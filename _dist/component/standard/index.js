...
function add_css$1(target) {
	append_styles(target, "svelte-qd1tc3", ".tjs-menu.svelte-qd1tc3.svelte-qd1tc3.svelte-qd1tc3{position:absolute;width:fit-content;height:max-content;box-shadow:0 0 2px var(--color-shadow-dark, var(--typhonjs-color-shadow, #000));background:var(--typhonjs-color-content-window, #23221d);border:1px solid var(--color-border-dark, var(--typhonjs-color-border, #000));border-radius:5px;color:var(--color-text-light-primary, var(--typhonjs-color-text-secondary, #EEE));text-align:left}.tjs-menu.svelte-qd1tc3 ol.tjs-menu-items.svelte-qd1tc3.svelte-qd1tc3{list-style:none;margin:0;padding:0}.tjs-menu.svelte-qd1tc3 li.tjs-menu-item.svelte-qd1tc3.svelte-qd1tc3{padding:0 0.5em;line-height:2em}.tjs-menu.svelte-qd1tc3 li.tjs-menu-item.svelte-qd1tc3.svelte-qd1tc3:hover{color:var(--typhonjs-color-text-primary, #FFF);text-shadow:0 0 4px var(--color-text-hyperlink, var(--typhonjs-color-accent-tertiary, red))}.tjs-menu.svelte-qd1tc3 li.tjs-menu-item.svelte-qd1tc3>i.svelte-qd1tc3{margin-right:5px}");
}
...
function create_each_block$1(ctx) {
	...
	return {
		c() {
			...
			i = element("i");
			t = text(t_value);
			attr(i, "class", i_class_value = "" + (null_to_empty(/*item*/ ctx[18].icon) + " svelte-qd1tc3"));
			attr(li, "class", "tjs-menu-item svelte-qd1tc3");
		},
		m(target, anchor) {
		...
		p(new_ctx, dirty) {
			...
			if (dirty & /*items*/ 1 && i_class_value !== (i_class_value = "" + (null_to_empty(/*item*/ ctx[18].icon) + " svelte-qd1tc3"))) {
				attr(i, "class", i_class_value);
			}
...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			attr(ol, "class", "tjs-menu-items svelte-qd1tc3");
			attr(nav, "class", "tjs-menu svelte-qd1tc3");
		},
		m(target, anchor) {
...
function add_css(target) {
	append_styles(target, "svelte-ad00kw", ".tjs-context-menu.svelte-ad00kw.svelte-ad00kw.svelte-ad00kw{position:fixed;width:fit-content;font-size:14px;box-shadow:0 0 10px var(--color-shadow-dark, var(--typhonjs-color-shadow, #000));height:max-content;min-width:20px;max-width:360px;background:var(--typhonjs-color-content-window, #23221d);border:1px solid var(--color-border-dark, var(--typhonjs-color-border, #000));border-radius:5px;color:var(--color-text-light-primary, var(--typhonjs-color-text-secondary, #EEE))}.tjs-context-menu.svelte-ad00kw ol.tjs-context-items.svelte-ad00kw.svelte-ad00kw{list-style:none;margin:0;padding:0}.tjs-context-menu.svelte-ad00kw li.tjs-context-item.svelte-ad00kw.svelte-ad00kw{padding:0 0.5em;line-height:2em}.tjs-context-menu.svelte-ad00kw li.tjs-context-item.svelte-ad00kw.svelte-ad00kw:hover{color:var(--typhonjs-color-text-primary, #FFF);text-shadow:0 0 4px var(--color-text-hyperlink, var(--typhonjs-color-accent-tertiary, red))}.tjs-context-menu.svelte-ad00kw li.tjs-context-item.svelte-ad00kw>i.svelte-ad00kw{margin-right:5px}");
}
...
function create_each_block(ctx) {
	...
	return {
		c() {
			...
			i = element("i");
			t = text(t_value);
			attr(i, "class", i_class_value = "" + (null_to_empty(/*item*/ ctx[17].icon) + " svelte-ad00kw"));
			attr(li, "class", "tjs-context-item svelte-ad00kw");
		},
		m(target, anchor) {
			insert(target, li, anchor);
			append(li, i);
		...
		p(new_ctx, dirty) {
			...
			if (dirty & /*items*/ 2 && i_class_value !== (i_class_value = "" + (null_to_empty(/*item*/ ctx[17].icon) + " svelte-ad00kw"))) {
				attr(i, "class", i_class_value);
			}
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			t2 = space();
			if (after_slot) after_slot.c();
			attr(ol, "class", "tjs-context-items svelte-ad00kw");
			attr(nav, "id", /*id*/ ctx[0]);
			attr(nav, "class", "tjs-context-menu svelte-ad00kw");
