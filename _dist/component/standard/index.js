...
/* src\component\standard\button\TJSIconButton.svelte generated by Svelte v3.48.0 */
...
/* src\component\standard\button\TJSToggleIconButton.svelte generated by Svelte v3.48.0 */

function add_css$a(target) {
	append_styles(target, "svelte-dz6ab0", "div.svelte-dz6ab0{pointer-events:none;display:block;position:relative;flex:0 0 var(--tjs-icon-button-diameter);height:var(--tjs-icon-button-diameter);width:var(--tjs-icon-button-diameter);align-self:center;text-align:center}a.svelte-dz6ab0{pointer-events:initial;display:inline-block;background:var(--tjs-icon-button-background);border-radius:var(--tjs-icon-button-border-radius);position:relative;overflow:hidden;clip-path:var(--tjs-icon-button-clip-path, none);transform-style:preserve-3d;width:100%;height:100%;transition:var(--tjs-icon-button-transition)}a.svelte-dz6ab0:hover{background:var(--tjs-icon-button-background-hover);clip-path:var(--tjs-icon-button-clip-path-hover, var(--tjs-icon-button-clip-path, none))}a.selected.svelte-dz6ab0{background:var(--tjs-icon-button-background-selected);clip-path:var(--tjs-icon-button-clip-path-selected, var(--tjs-icon-button-clip-path, none))}i.svelte-dz6ab0{line-height:var(--tjs-icon-button-diameter);transform:translateZ(1px)}");
}
...
function create_fragment$b(ctx) {
	...
	return {
		c() {
			...
			attr(i, "class", i_class_value = "" + (null_to_empty(/*icon*/ ctx[0]) + " svelte-dz6ab0"));
			attr(i, "title", i_title_value = localize(/*title*/ ctx[1]));
			toggle_class(i, "selected", /*selected*/ ctx[5]);
			attr(a, "class", "svelte-dz6ab0");
			toggle_class(a, "selected", /*selected*/ ctx[5]);
			attr(div, "class", "svelte-dz6ab0");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, a);
			...
			if (!mounted) {
				dispose = [
					...
					listen(div, "close", /*close_handler*/ ctx[14]),
					listen(div, "click", /*click_handler*/ ctx[15]),
					listen(div, "close", /*onClose*/ ctx[7]),
		...
		p(ctx, [dirty]) {
			if (!current || dirty & /*icon*/ 1 && i_class_value !== (i_class_value = "" + (null_to_empty(/*icon*/ ctx[0]) + " svelte-dz6ab0"))) {
				attr(i, "class", i_class_value);
			}
 ...
 */
	...
	$$self.$$set = $$props => {
		if ('button' in $$props) $$invalidate(10, button = $$props.button);
		if ('icon' in $$props) $$invalidate(0, icon = $$props.icon);
		if ('title' in $$props) $$invalidate(1, title = $$props.title);
		...
		if ('onClickPropagate' in $$props) $$invalidate(8, onClickPropagate = $$props.onClickPropagate);
		if ('onClosePropagate' in $$props) $$invalidate(9, onClosePropagate = $$props.onClosePropagate);
		if ('$$scope' in $$props) $$invalidate(12, $$scope = $$props.$$scope);
	};

	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*button, icon*/ 1025) {
			$$invalidate(0, icon = typeof button === 'object' && typeof button.icon === 'string'
			? button.icon
			: typeof icon === 'string' ? icon : '');
		}

		if ($$self.$$.dirty & /*button, title*/ 1026) {
			$$invalidate(1, title = typeof button === 'object' && typeof button.title === 'string'
			? button.title
			: typeof title === 'string' ? title : '');
		}

		if ($$self.$$.dirty & /*button, store*/ 1028) {
			$$subscribe_store($$invalidate(2, store = typeof button === 'object' && isWritableStore(button.store)
			? button.store
			: isWritableStore(store) ? store : void 0));
		}

		if ($$self.$$.dirty & /*button, styles*/ 1032) {
			$$invalidate(3, styles = typeof button === 'object' && typeof button.styles === 'object'
			? button.styles
			: typeof styles === 'object' ? styles : void 0);
		}

		if ($$self.$$.dirty & /*button, efx*/ 1040) {
		...
		if ($$self.$$.dirty & /*button, onClosePropagate*/ 1536) {
			$$invalidate(9, onClosePropagate = typeof button === 'object' && typeof button.onClosePropagate === 'boolean'
		...
		if ($$self.$$.dirty & /*button, onClickPropagate*/ 1280) {
			$$invalidate(8, onClickPropagate = typeof button === 'object' && typeof button.onClickPropagate === 'boolean'
			? button.onClickPropagate
			: typeof onClickPropagate === 'boolean'
				? onClickPropagate
				: true);
		...
		if ($$self.$$.dirty & /*store, $store*/ 2052) {
			if (store) {
...
/* src\component\standard\folder\TJSSvgFolder.svelte generated by Svelte v3.48.0 */
...
/* src\component\standard\folder\TJSIconFolder.svelte generated by Svelte v3.48.0 */
...
/* src\component\standard\form\input\TJSInput.svelte generated by Svelte v3.48.0 */
...
/* src\component\standard\form\select\TJSSelect.svelte generated by Svelte v3.48.0 */
...
/* src\component\standard\layers\position-control\control\resize\ResizeHitBox.svelte generated by Svelte v3.48.0 */
...
/* src\component\standard\layers\position-control\control\resize\ResizeControl.svelte generated by Svelte v3.48.0 */
...
/* src\component\standard\layers\position-control\control\SelectedBorder.svelte generated by Svelte v3.48.0 */
...
/* src\component\standard\layers\position-control\control\PositionControl.svelte generated by Svelte v3.48.0 */
...
/* src\component\standard\layers\position-control\TJSPositionControlLayer.svelte generated by Svelte v3.48.0 */
...
/* src\component\standard\menu\TJSMenu.svelte generated by Svelte v3.48.0 */
...
/* src\component\standard\menu\context\TJSContextMenu.svelte generated by Svelte v3.48.0 */
