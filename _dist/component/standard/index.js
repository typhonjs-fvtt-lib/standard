import { SvelteComponent, init, safe_not_equal, append_styles, update_slot_base, get_all_dirty_from_scope, get_slot_changes, transition_in, transition_out, element, space, attr, null_to_empty, toggle_class, insert, append, listen, action_destroyer, stop_propagation, prevent_default, group_outros, check_outros, is_function, detach, run_all, subscribe, create_slot, noop, bubble, svg_element, set_style, text, set_data, binding_callbacks, HtmlTag, set_input_value, add_render_callback, select_option, destroy_each, select_value, create_bidirectional_transition, component_subscribe, globals, current_component } from 'svelte/internal';
...
function add_css$4(target) {
	append_styles(target, "svelte-177pf0l", "details.svelte-177pf0l.svelte-177pf0l{margin-left:-5px;padding-left:var(--tjs-details-padding-left, 5px)}summary.svelte-177pf0l.svelte-177pf0l{position:relative;align-items:center;background-blend-mode:var(--tjs-summary-background-blend-mode, initial);background:var(--tjs-summary-background, none);border:var(--tjs-summary-border, none);cursor:var(--tjs-summary-cursor, pointer);font-size:var(--tjs-summary-font-size, inherit);font-weight:var(--tjs-summary-font-weight, bold);list-style:none;padding:var(--tjs-summary-padding, 4px) 0;user-select:none;width:var(--tjs-summary-width, fit-content)}.contents.svelte-177pf0l.svelte-177pf0l{position:relative;background-blend-mode:var(--tjs-contents-background-blend-mode, initial);background:var(--tjs-contents-background, none);border:var(--tjs-contents-border, none);margin:var(--tjs-contents-margin, 0 0 0 -5px);padding:var(--tjs-contents-padding, 0 0 0 calc(var(--tjs-summary-font-size, 13px) * 0.8))}.contents.svelte-177pf0l.svelte-177pf0l::before{content:'';position:absolute;width:0;height:calc(100% + 8px);left:0;top:-8px}summary.svelte-177pf0l:focus-visible+.contents.svelte-177pf0l::before{height:100%;top:0}");
}
...
function create_fragment$5(ctx) {
	...
	return {
		c() {
			...
			if (default_slot) default_slot.c();
			html_tag.a = t0;
			attr(summary, "class", "svelte-177pf0l");
			attr(div, "class", "contents svelte-177pf0l");
			attr(details, "class", "tjs-icon-folder svelte-177pf0l");
			attr(details, "data-id", /*id*/ ctx[0]);
			attr(details, "data-label", /*label*/ ctx[1]);
			attr(details, "data-closing", "false");
		},
		m(target, anchor) {
			insert(target, details, anchor);
			append(details, summary);
			html_tag.m(/*currentIcon*/ ctx[5], summary);
			append(summary, t0);
		...
		p(ctx, [dirty]) {
			if (!current || dirty & /*currentIcon*/ 32) html_tag.p(/*currentIcon*/ ctx[5]);
 ...
 */
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*folder, iconOpen*/ 320) {
			$$invalidate(6, iconOpen = typeof folder === 'object'
			? folder.iconOpen
			: typeof iconOpen === 'string' ? iconOpen : void 0);
		}

		if ($$self.$$.dirty & /*folder, iconClosed*/ 384) {
			$$invalidate(7, iconClosed = typeof folder === 'object'
			? folder.iconClosed
		...
		if ($$self.$$.dirty & /*folder, store*/ 260) {
			$$subscribe_store($$invalidate(2, store = typeof folder === 'object' && isStore(folder.store)
			? folder.store
			: isStore(store) ? store : writable(false)));
		}
		...
		if ($$self.$$.dirty & /*$store, iconOpen, iconClosed*/ 704) {
			{
				...
				$$invalidate(5, currentIcon = typeof iconData !== 'string'
				? void 0
				: s_REGEX_HTML.test(iconData)
					? iconData
					: `<i class="${iconData}"></i>`);
			}
		}
