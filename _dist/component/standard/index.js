...
function add_css$8(target) {
	append_styles(target, "svelte-ggza9o", ".tjs-input-container.svelte-ggza9o{pointer-events:none;background:var(--tjs-input-text-background, var(--tjs-input-background));border-radius:var(--tjs-input-text-border-radius, var(--tjs-input-border-radius));display:block;overflow:hidden;height:var(--tjs-input-text-height, var(--tjs-input-height));width:var(--tjs-input-text-width, var(--tjs-input-width));transform-style:preserve-3d}input.svelte-ggza9o{pointer-events:initial;display:inline-block;position:relative;overflow:hidden;background:transparent;border:var(--tjs-input-text-border, var(--tjs-input-border));border-radius:var(--tjs-input-text-border-radius, var(--tjs-input-border-radius));text-align:var(--tjs-input-text-text-align, var(--tjs-input-text-align));width:100%;height:100%;padding:var(--tjs-input-text-padding, var(--tjs-input-padding, initial));color:inherit;font-family:inherit;font-size:inherit;line-height:inherit;cursor:var(--tjs-input-text-cursor, var(--tjs-input-cursor, text));transform:translateZ(1px)}input.svelte-ggza9o::placeholder{color:var(--tjs-input-text-placeholder-color, var(--tjs-input-placeholder-color, inherit))}");
}
...
function create_fragment$a(ctx) {
	...
	return {
		c() {
			...
			toggle_class(input_1, "svelte-ggza9o", true);
			attr(div, "class", "tjs-input-container svelte-ggza9o");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, input_1);
...
function add_css$1(target) {
	append_styles(target, "svelte-14ioya", ".tjs-menu.svelte-14ioya.svelte-14ioya{position:absolute;width:max-content;height:max-content;background:var(--tjs-menu-background, #23221d);border:var(--tjs-menu-border, 1px solid #000);border-radius:var(--tjs-menu-border-radius, 5px);box-shadow:var(--tjs-menu-box-shadow, 0 0 2px #000);color:var(--tjs-menu-color, #EEE);text-align:start;z-index:var(--tjs-menu-z-index, 100)}.tjs-menu.svelte-14ioya section.tjs-menu-items.svelte-14ioya{margin:0;padding:0}.tjs-menu.svelte-14ioya div.tjs-menu-item.svelte-14ioya{display:flex;align-items:center;padding:0 0.5em;line-height:2em}.tjs-menu.svelte-14ioya div.tjs-menu-item.svelte-14ioya:hover{color:var(--tjs-menu-item-hover-color, #FFF);text-shadow:0 0 4px var(--tjs-menu-item-hover-text-shadow-color, red)}.tjs-menu.svelte-14ioya section.tjs-menu-items hr.svelte-14ioya{margin-block-start:0;margin-block-end:0;margin:0 0.15em;border-top:1px solid var(--tjs-menu-hr-border-top-color, #555);border-bottom:1px solid var(--tjs-menu-hr-border-bottom-color, #444)}.tjs-menu.svelte-14ioya div.tjs-menu-item i.svelte-14ioya{width:1em;margin-right:0.25em}.tjs-menu.svelte-14ioya div.tjs-menu-item img.svelte-14ioya{width:1em;height:1em;margin-right:0.25em}");
}
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			...
			i = element("i");
			t = text(t_value);
			attr(i, "class", i_class_value = "" + (null_to_empty(/*item*/ ctx[19].icon) + " svelte-14ioya"));
			attr(div, "class", "tjs-menu-item svelte-14ioya");
		},
		m(target, anchor) {
			insert(target, div, anchor);
		...
		p(new_ctx, dirty) {
			...
			if (dirty & /*allItems*/ 2 && i_class_value !== (i_class_value = "" + (null_to_empty(/*item*/ ctx[19].icon) + " svelte-14ioya"))) {
				attr(i, "class", i_class_value);
			}
