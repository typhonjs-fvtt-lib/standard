...
function add_css$5(target) {
	append_styles(target, "svelte-x74mvb", "details.svelte-x74mvb.svelte-x74mvb{margin-left:-5px;padding-left:var(--tjs-details-padding-left, 5px)}summary.svelte-x74mvb.svelte-x74mvb{display:flex;position:relative;align-items:center;background-blend-mode:var(--tjs-summary-background-blend-mode, initial);background:var(--tjs-summary-background, none);border:var(--tjs-summary-border, none);border-radius:var(--tjs-summary-border-radius, 0);border-width:var(--tjs-summary-border-width, initial);cursor:var(--tjs-summary-cursor, pointer);font-size:var(--tjs-summary-font-size, inherit);font-weight:var(--tjs-summary-font-weight, bold);list-style:none;margin:var(--tjs-summary-margin, 0 0 0 -5px);padding:var(--tjs-summary-padding, 4px) 0;user-select:none;width:var(--tjs-summary-width, fit-content)}summary.svelte-x74mvb svg.svelte-x74mvb{width:var(--tjs-summary-chevron-size, var(--tjs-summary-font-size, 15px));height:var(--tjs-summary-chevron-size, var(--tjs-summary-font-size, 15px));color:var(--tjs-summary-chevron-color, currentColor);opacity:var(--tjs-summary-chevron-opacity, 0.2);margin:0 5px 0 0;transition:opacity 0.2s, transform 0.1s;transform:rotate(var(--tjs-summary-chevron-rotate-closed, -90deg))}summary.svelte-x74mvb:hover svg.svelte-x74mvb{opacity:var(--tjs-summary-chevron-opacity-hover, 1)}details[open].svelte-x74mvb>summary.svelte-x74mvb{background:var(--tjs-summary-background-open, var(--tjs-summary-background, inherit))}[open].svelte-x74mvb:not(details[data-closing='true'])>summary svg.svelte-x74mvb{transform:rotate(var(--tjs-summary-chevron-rotate-open, 0))}.contents.svelte-x74mvb.svelte-x74mvb{position:relative;background-blend-mode:var(--tjs-contents-background-blend-mode, initial);background:var(--tjs-contents-background, none);border:var(--tjs-contents-border, none);margin:var(--tjs-contents-margin, 0 0 0 -5px);padding:var(--tjs-contents-padding, 0 0 0 calc(var(--tjs-summary-font-size, 13px) * 0.8))}.contents.svelte-x74mvb.svelte-x74mvb::before{content:'';position:absolute;width:0;height:calc(100% + 8px);left:0;top:-8px}summary.svelte-x74mvb:focus-visible+.contents.svelte-x74mvb::before{height:100%;top:0}");
}
...
function create_fragment$6(ctx) {
	...
	const summary_end_slot_template = /*#slots*/ ctx[9]["summary-end"];
	const summary_end_slot = create_slot(summary_end_slot_template, ctx, /*$$scope*/ ctx[8], get_summary_end_slot_context$1);
	...
	return {
		c() {
			...
			attr(svg, "class", "svelte-x74mvb");
			attr(summary, "class", "svelte-x74mvb");
			attr(div, "class", "contents svelte-x74mvb");
			attr(details, "class", "tjs-folder svelte-x74mvb");
		...
		m(target, anchor) {
			...
			/*details_binding*/ ctx[15](details);
			current = true;

			if (!mounted) {
				dispose = [
					listen(details, "click", /*click_handler*/ ctx[10]),
					listen(details, "open", /*open_handler*/ ctx[11]),
					listen(details, "close", /*close_handler*/ ctx[12]),
					listen(details, "openAny", /*openAny_handler*/ ctx[13]),
					listen(details, "closeAny", /*closeAny_handler*/ ctx[14]),
		...
		p(ctx, [dirty]) {
			...
			if (summary_end_slot) {
				if (summary_end_slot.p && (!current || dirty & /*$$scope*/ 256)) {
					update_slot_base(
						summary_end_slot,
						...
						!current
						? get_all_dirty_from_scope(/*$$scope*/ ctx[8])
						: get_slot_changes(summary_end_slot_template, /*$$scope*/ ctx[8], dirty, get_summary_end_slot_changes$1),
...
function instance$6($$self, $$props, $$invalidate) {
	...
	let { id = isObject(folder) ? folder.id : void 0 } = $$props;
	let { label = isObject(folder) ? folder.label : '' } = $$props;
	let { store = isObject(folder) ? folder.store : writable(false) } = $$props;
	let { onClick = isObject(folder) ? folder.onClick : () => null } = $$props;
	let { onContextMenu = isObject(folder) ? folder.onContextMenu : () => null } = $$props;
	let detailsEl;
 ...
 */
	...
	$$self.$$set = $$props => {
		if ('styles' in $$props) $$invalidate(3, styles = $$props.styles);
		if ('folder' in $$props) $$invalidate(7, folder = $$props.folder);
		if ('id' in $$props) $$invalidate(0, id = $$props.id);
		if ('label' in $$props) $$invalidate(1, label = $$props.label);
		if ('store' in $$props) $$invalidate(2, store = $$props.store);
		if ('onClick' in $$props) $$invalidate(5, onClick = $$props.onClick);
		if ('onContextMenu' in $$props) $$invalidate(6, onContextMenu = $$props.onContextMenu);
		if ('$$scope' in $$props) $$invalidate(8, $$scope = $$props.$$scope);
	};

	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*folder, id*/ 129) {
			$$invalidate(0, id = isObject(folder)
			? folder.id
			: typeof id === 'string' ? id : void 0);
		}

		if ($$self.$$.dirty & /*folder, label*/ 130) {
			$$invalidate(1, label = isObject(folder)
			? folder.label
		...
		if ($$self.$$.dirty & /*folder, onClick*/ 160) {
			$$invalidate(5, onClick = isObject(folder) && typeof folder.onClick === 'function'
			? folder.onClick
			: typeof onClick === 'function' ? onClick : () => null);
		}

		if ($$self.$$.dirty & /*folder, onContextMenu*/ 192) {
			$$invalidate(6, onContextMenu = isObject(folder) && typeof folder.onContextMenu === 'function'
...
function add_css$4(target) {
	append_styles(target, "svelte-rr4toj", "details.svelte-rr4toj.svelte-rr4toj{margin-left:-5px;padding-left:var(--tjs-details-padding-left, 5px)}summary.svelte-rr4toj.svelte-rr4toj{display:flex;position:relative;align-items:center;background-blend-mode:var(--tjs-summary-background-blend-mode, initial);background:var(--tjs-summary-background, none);border:var(--tjs-summary-border, none);border-radius:var(--tjs-summary-border-radius, 0);border-width:var(--tjs-summary-border-width, initial);cursor:var(--tjs-summary-cursor, pointer);font-size:var(--tjs-summary-font-size, inherit);font-weight:var(--tjs-summary-font-weight, bold);list-style:none;margin:var(--tjs-summary-margin, 0);padding:var(--tjs-summary-padding, 4px) 0;user-select:none;width:var(--tjs-summary-width, fit-content);transition:background 0.1s}summary.svelte-rr4toj i.svelte-rr4toj{color:var(--tjs-summary-chevron-color, currentColor);opacity:var(--tjs-summary-chevron-opacity, 1);margin:0 0 0 0.25em;width:var(--tjs-summary-chevron-width, 1.65em);transition:opacity 0.2s}summary.svelte-rr4toj:hover i.svelte-rr4toj{opacity:var(--tjs-summary-chevron-opacity-hover, 1)}details[open].svelte-rr4toj>summary.svelte-rr4toj{background:var(--tjs-summary-background-open, var(--tjs-summary-background, inherit))}.contents.svelte-rr4toj.svelte-rr4toj{position:relative;background-blend-mode:var(--tjs-contents-background-blend-mode, initial);background:var(--tjs-contents-background, none);border:var(--tjs-contents-border, none);margin:var(--tjs-contents-margin, 0 0 0 -5px);padding:var(--tjs-contents-padding, 0 0 0 calc(var(--tjs-summary-font-size, 13px) * 0.8))}.contents.svelte-rr4toj.svelte-rr4toj::before{content:'';position:absolute;width:0;height:calc(100% + 8px);left:0;top:-8px}summary.svelte-rr4toj:focus-visible+.contents.svelte-rr4toj::before{height:100%;top:0}");
}
...
function create_if_block(ctx) {
	...
	return {
		c() {
			i = element("i");
			attr(i, "class", i_class_value = "" + (null_to_empty(/*currentIcon*/ ctx[7]) + " svelte-rr4toj"));
		},
		m(target, anchor) {
			insert(target, i, anchor);
		},
		p(ctx, dirty) {
			if (dirty & /*currentIcon*/ 128 && i_class_value !== (i_class_value = "" + (null_to_empty(/*currentIcon*/ ctx[7]) + " svelte-rr4toj"))) {
				attr(i, "class", i_class_value);
			}
		},
		d(detaching) {
...
function create_fragment$5(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*currentIcon*/ ctx[7] && create_if_block(ctx);
	...
	const summary_end_slot_template = /*#slots*/ ctx[13]["summary-end"];
	const summary_end_slot = create_slot(summary_end_slot_template, ctx, /*$$scope*/ ctx[12], get_summary_end_slot_context);
	...
	return {
		c() {
			...
			div = element("div");
			if (default_slot) default_slot.c();
			attr(summary, "class", "svelte-rr4toj");
			attr(div, "class", "contents svelte-rr4toj");
			attr(details, "class", "tjs-icon-folder svelte-rr4toj");
			attr(details, "data-id", /*id*/ ctx[0]);
			attr(details, "data-label", /*label*/ ctx[1]);
			attr(details, "data-closing", "false");
		},
		m(target, anchor) {
			...
			/*details_binding*/ ctx[19](details);
			current = true;
			...
			if (!mounted) {
				dispose = [
					...
					listen(details, "click", /*click_handler*/ ctx[14]),
					listen(details, "open", /*open_handler*/ ctx[15]),
					listen(details, "close", /*close_handler*/ ctx[16]),
					listen(details, "openAny", /*openAny_handler*/ ctx[17]),
					listen(details, "closeAny", /*closeAny_handler*/ ctx[18]),
					action_destroyer(toggleDetails_action = toggleDetails.call(null, details, /*store*/ ctx[2])),
					action_destroyer(applyStyles_action = applyStyles.call(null, details, /*styles*/ ctx[5]))
				];
		...
		p(new_ctx, [dirty]) {
			...
			if (summary_end_slot) {
				if (summary_end_slot.p && (!current || dirty & /*$$scope*/ 4096)) {
					update_slot_base(
						summary_end_slot,
						summary_end_slot_template,
						ctx,
						...
						!current
						? get_all_dirty_from_scope(/*$$scope*/ ctx[12])
						: get_slot_changes(summary_end_slot_template, /*$$scope*/ ctx[12], dirty, get_summary_end_slot_changes),
...
function instance$5($$self, $$props, $$invalidate) {
	...
	let { folder = void 0 } = $$props;
	let { id = isObject(folder) ? folder.id : void 0 } = $$props;
	let { iconOpen = isObject(folder) ? folder.iconOpen : '' } = $$props;
	let { iconClosed = isObject(folder) ? folder.iconClosed : '' } = $$props;
	let { label = isObject(folder) ? folder.label : '' } = $$props;
	let { store = isObject(folder) ? folder.store : writable(false) } = $$props;
	$$subscribe_store();
	let { onClick = isObject(folder) ? folder.onClick : () => null } = $$props;
 ...
 */
	...
	$$self.$$set = $$props => {
		...
		if ('id' in $$props) $$invalidate(0, id = $$props.id);
		if ('iconOpen' in $$props) $$invalidate(8, iconOpen = $$props.iconOpen);
		if ('iconClosed' in $$props) $$invalidate(9, iconClosed = $$props.iconClosed);
		if ('label' in $$props) $$invalidate(1, label = $$props.label);
		if ('store' in $$props) $$subscribe_store($$invalidate(2, store = $$props.store));
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*folder, iconOpen*/ 1280) {
			$$invalidate(8, iconOpen = isObject(folder)
			? folder.iconOpen
			: typeof iconOpen === 'string' ? iconOpen : void 0);
		}

		if ($$self.$$.dirty & /*folder, iconClosed*/ 1536) {
			$$invalidate(9, iconClosed = isObject(folder)
			? folder.iconClosed
		...
		if ($$self.$$.dirty & /*folder, onClick*/ 1032) {
			$$invalidate(3, onClick = isObject(folder) && typeof folder.onClick === 'function'
			? folder.onClick
			: typeof onClick === 'function' ? onClick : () => null);
		}
		...
		if ($$self.$$.dirty & /*$store, iconOpen, iconClosed*/ 2816) {
			{
				const iconData = $store ? iconOpen : iconClosed;
				$$invalidate(7, currentIcon = typeof iconData !== 'string' ? void 0 : iconData);
			}
		}
	};
