...
function add_css$5(target) {
	append_styles(target, "svelte-vkwqzu", "details.svelte-vkwqzu.svelte-vkwqzu{margin-left:-5px;padding-left:var(--tjs-details-padding-left, 5px)}summary.svelte-vkwqzu.svelte-vkwqzu{display:flex;position:relative;align-items:center;background-blend-mode:var(--tjs-summary-background-blend-mode, initial);background:var(--tjs-summary-background, none);border:var(--tjs-summary-border, none);border-radius:var(--tjs-summary-border-radius, 0);border-width:var(--tjs-summary-border-width, initial);cursor:var(--tjs-summary-cursor, pointer);font-size:var(--tjs-summary-font-size, inherit);font-weight:var(--tjs-summary-font-weight, bold);list-style:none;margin:var(--tjs-summary-margin, 0 0 0 -5px);padding:var(--tjs-summary-padding, 4px) 0;user-select:none;width:var(--tjs-summary-width, fit-content)}summary.svelte-vkwqzu svg.svelte-vkwqzu{width:var(--tjs-summary-chevron-size, var(--tjs-summary-font-size, 15px));height:var(--tjs-summary-chevron-size, var(--tjs-summary-font-size, 15px));color:var(--tjs-summary-chevron-color, currentColor);opacity:var(--tjs-summary-chevron-opacity, 0.2);margin:0 5px 0 0;transition:opacity 0.2s, transform 0.1s;transform:rotate(var(--tjs-summary-chevron-rotate-closed, -90deg))}summary.svelte-vkwqzu:hover svg.svelte-vkwqzu{opacity:var(--tjs-summary-chevron-opacity-hover, 1)}details[open].svelte-vkwqzu>summary.svelte-vkwqzu{background:var(--tjs-summary-background-open, var(--tjs-summary-background, inherit))}[open].svelte-vkwqzu:not(details[data-closing='true'])>summary svg.svelte-vkwqzu{transform:rotate(var(--tjs-summary-chevron-rotate-open, 0))}.contents.svelte-vkwqzu.svelte-vkwqzu{position:relative;background-blend-mode:var(--tjs-contents-background-blend-mode, initial);background:var(--tjs-contents-background, none);border:var(--tjs-contents-border, none);margin:var(--tjs-contents-margin, 0 0 0 -5px);padding:var(--tjs-contents-padding, 0 0 0 calc(var(--tjs-summary-font-size, 13px) * 0.8))}.contents.svelte-vkwqzu.svelte-vkwqzu::before{content:'';position:absolute;width:0;height:calc(100% + 8px);left:0;top:-8px}summary.svelte-vkwqzu:focus-visible+.contents.svelte-vkwqzu::before{height:100%;top:0}");
}
...
function create_fragment$6(ctx) {
	...
	const label_slot = create_slot(label_slot_template, ctx, /*$$scope*/ ctx[6], get_label_slot_context$1);
	const label_slot_or_fallback = label_slot || fallback_block$1(ctx);
	const summary_end_slot_template = /*#slots*/ ctx[7]["summary-end"];
	const summary_end_slot = create_slot(summary_end_slot_template, ctx, /*$$scope*/ ctx[6], get_summary_end_slot_context$1);
	...
	return {
		c() {
			...
			attr(svg, "class", "svelte-vkwqzu");
			attr(summary, "class", "svelte-vkwqzu");
			attr(div, "class", "contents svelte-vkwqzu");
			attr(details, "class", "tjs-folder svelte-vkwqzu");
			...
			if (label_slot) {
				if (label_slot.p && (!current || dirty & /*$$scope*/ 64)) {
					update_slot_base(
						...
						: get_slot_changes(label_slot_template, /*$$scope*/ ctx[6], dirty, get_label_slot_changes$1),
			...
			if (summary_end_slot) {
				if (summary_end_slot.p && (!current || dirty & /*$$scope*/ 64)) {
					update_slot_base(
						...
						!current
						? get_all_dirty_from_scope(/*$$scope*/ ctx[6])
						: get_slot_changes(summary_end_slot_template, /*$$scope*/ ctx[6], dirty, get_summary_end_slot_changes$1),
...
function add_css$4(target) {
	append_styles(target, "svelte-czqskk", "details.svelte-czqskk.svelte-czqskk{margin-left:-5px;padding-left:var(--tjs-details-padding-left, 5px)}summary.svelte-czqskk.svelte-czqskk{display:flex;position:relative;align-items:center;background-blend-mode:var(--tjs-summary-background-blend-mode, initial);background:var(--tjs-summary-background, none);border:var(--tjs-summary-border, none);border-radius:var(--tjs-summary-border-radius, 0);border-width:var(--tjs-summary-border-width, initial);cursor:var(--tjs-summary-cursor, pointer);font-size:var(--tjs-summary-font-size, inherit);font-weight:var(--tjs-summary-font-weight, bold);list-style:none;margin:var(--tjs-summary-margin, 0);padding:var(--tjs-summary-padding, 4px) 0;user-select:none;width:var(--tjs-summary-width, fit-content)}summary.svelte-czqskk i.svelte-czqskk{color:var(--tjs-summary-chevron-color, currentColor);opacity:var(--tjs-summary-chevron-opacity, 1);margin:0 0.5em 0 0.25em;transition:opacity 0.2s}summary.svelte-czqskk:hover i.svelte-czqskk{opacity:var(--tjs-summary-chevron-opacity-hover, 1)}details[open].svelte-czqskk>summary.svelte-czqskk{background:var(--tjs-summary-background-open, var(--tjs-summary-background, inherit))}.contents.svelte-czqskk.svelte-czqskk{position:relative;background-blend-mode:var(--tjs-contents-background-blend-mode, initial);background:var(--tjs-contents-background, none);border:var(--tjs-contents-border, none);margin:var(--tjs-contents-margin, 0 0 0 -5px);padding:var(--tjs-contents-padding, 0 0 0 calc(var(--tjs-summary-font-size, 13px) * 0.8))}.contents.svelte-czqskk.svelte-czqskk::before{content:'';position:absolute;width:0;height:calc(100% + 8px);left:0;top:-8px}summary.svelte-czqskk:focus-visible+.contents.svelte-czqskk::before{height:100%;top:0}");
}
...
function create_if_block(ctx) {
	...
	return {
		c() {
			i = element("i");
			attr(i, "class", i_class_value = "" + (null_to_empty(/*currentIcon*/ ctx[5]) + " svelte-czqskk"));
		},
		m(target, anchor) {
			insert(target, i, anchor);
		},
		p(ctx, dirty) {
			if (dirty & /*currentIcon*/ 32 && i_class_value !== (i_class_value = "" + (null_to_empty(/*currentIcon*/ ctx[5]) + " svelte-czqskk"))) {
				attr(i, "class", i_class_value);
			}
		},
		d(detaching) {
...
function create_fragment$5(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*currentIcon*/ ctx[5] && create_if_block(ctx);
	...
	const summary_end_slot_template = /*#slots*/ ctx[11]["summary-end"];
	const summary_end_slot = create_slot(summary_end_slot_template, ctx, /*$$scope*/ ctx[10], get_summary_end_slot_context);
	const default_slot_template = /*#slots*/ ctx[11].default;
	const default_slot = create_slot(default_slot_template, ctx, /*$$scope*/ ctx[10], null);
	...
	return {
		c() {
			...
			div = element("div");
			if (default_slot) default_slot.c();
			attr(summary, "class", "svelte-czqskk");
			attr(div, "class", "contents svelte-czqskk");
			attr(details, "class", "tjs-icon-folder svelte-czqskk");
			attr(details, "data-id", /*id*/ ctx[0]);
			attr(details, "data-label", /*label*/ ctx[1]);
			attr(details, "data-closing", "false");
		},
		m(target, anchor) {
			...
			/*details_binding*/ ctx[17](details);
			current = true;

			if (!mounted) {
				dispose = [
					listen(details, "click", /*click_handler*/ ctx[12]),
					listen(details, "open", /*open_handler*/ ctx[13]),
					listen(details, "close", /*close_handler*/ ctx[14]),
					listen(details, "openAny", /*openAny_handler*/ ctx[15]),
					listen(details, "closeAny", /*closeAny_handler*/ ctx[16]),
					action_destroyer(toggleDetails_action = toggleDetails.call(null, details, /*store*/ ctx[2])),
					action_destroyer(applyStyles_action = applyStyles.call(null, details, /*styles*/ ctx[3]))
				];
		...
		p(ctx, [dirty]) {
			...
			if (label_slot) {
				if (label_slot.p && (!current || dirty & /*$$scope*/ 1024)) {
					update_slot_base(
						...
						!current
						? get_all_dirty_from_scope(/*$$scope*/ ctx[10])
						: get_slot_changes(label_slot_template, /*$$scope*/ ctx[10], dirty, get_label_slot_changes),
			...
			if (summary_end_slot) {
				if (summary_end_slot.p && (!current || dirty & /*$$scope*/ 1024)) {
					update_slot_base(
						summary_end_slot,
						summary_end_slot_template,
						ctx,
						...
						!current
						? get_all_dirty_from_scope(/*$$scope*/ ctx[10])
						: get_slot_changes(summary_end_slot_template, /*$$scope*/ ctx[10], dirty, get_summary_end_slot_changes),
...
function instance$5($$self, $$props, $$invalidate) {
	...
	let { id = folder ? folder.id : void 0 } = $$props;
	let { iconOpen = folder ? folder.iconOpen : '' } = $$props;
	let { iconClosed = folder ? folder.iconClosed : '' } = $$props;
	let { label = folder ? folder.label : '' } = $$props;
	let { store = folder ? folder.store : writable(false) } = $$props;
	$$subscribe_store();
	let detailsEl;
 ...
 */
	...
	$$self.$$set = $$props => {
		if ('styles' in $$props) $$invalidate(3, styles = $$props.styles);
		if ('folder' in $$props) $$invalidate(8, folder = $$props.folder);
		if ('id' in $$props) $$invalidate(0, id = $$props.id);
		if ('iconOpen' in $$props) $$invalidate(6, iconOpen = $$props.iconOpen);
		if ('iconClosed' in $$props) $$invalidate(7, iconClosed = $$props.iconClosed);
		if ('label' in $$props) $$invalidate(1, label = $$props.label);
		if ('store' in $$props) $$subscribe_store($$invalidate(2, store = $$props.store));
		if ('$$scope' in $$props) $$invalidate(10, $$scope = $$props.$$scope);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*folder, id*/ 257) {
			$$invalidate(0, id = isObject(folder)
			? folder.id
			: typeof id === 'string' ? id : void 0);
		}

		if ($$self.$$.dirty & /*folder, iconOpen*/ 320) {
			$$invalidate(6, iconOpen = isObject(folder)
			? folder.iconOpen
			: typeof iconOpen === 'string' ? iconOpen : void 0);
		}

		if ($$self.$$.dirty & /*folder, iconClosed*/ 384) {
			$$invalidate(7, iconClosed = isObject(folder)
			? folder.iconClosed
			: typeof iconClosed === 'string' ? iconClosed : void 0);
		}

		if ($$self.$$.dirty & /*folder, label*/ 258) {
			$$invalidate(1, label = isObject(folder)
			? folder.label
			: typeof label === 'string' ? label : '');
		}

		if ($$self.$$.dirty & /*folder, store*/ 260) {
			$$subscribe_store($$invalidate(2, store = isObject(folder) && isStore(folder.store)
			? folder.store
			: isStore(store) ? store : writable(false)));
		}

		if ($$self.$$.dirty & /*$store, iconOpen, iconClosed*/ 704) {
			{
				const iconData = $store ? iconOpen : iconClosed;
				$$invalidate(5, currentIcon = typeof iconData !== 'string' ? void 0 : iconData);
			}
		}
	};
